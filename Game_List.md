...
Below is a list of open source games and game-related projects that can be found on GitHub - old-school text adventures, old-time games, interesting clones of well-known games, add-ons/maps/hacks/plugins for commercial ones Games, libraries, frameworks, engines, whatever.
...
- [Windows/Linux Games](#user-content-Windows)
...
* [LWJake2](https://github.com/a-ivanov/LWJake2) - LWJGL port of Quake 2.
...
* [Crystal Picnic](https://github.com/Cloudxtreme/crystal-picnic) - Lighthearted and colourful tribute to the classic era of action RPGs.
